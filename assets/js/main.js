...
const galleries = {
  'hris-new': [
    ...
    { src: 'assets/img/HRIS-new/Performance index/Dashboard.png', caption: 'Performance Index — Dashboard' },
    { src: 'assets/img/HRIS-new/Performance index/iku_sasaran.png', caption: 'IKU — Daftar Sasaran' },
    { src: 'assets/img/HRIS-new/Performance index/iku_perencanaan.png', caption: 'IKU — Daftar Perencanaan' },
    { src: 'assets/img/HRIS-new/Performance index/iku_perencanaan_detail.png', caption: 'IKU — Detail Perencanaan' },
    { src: 'assets/img/HRIS-new/Performance index/iku_realisasi.png', caption: 'IKU — Daftar Realisasi' },
    { src: 'assets/img/HRIS-new/Performance index/iku_report.png', caption: 'IKU — Laporan Performance Index' },
    { src: 'assets/img/HRIS-new/Performance index/Approval.png', caption: 'IKU — Approval Institusi/Unit' },

    { src: 'assets/img/HRIS-new/Payroll/payroll_main.png', caption: 'Payroll — Halaman Utama' },
    { src: 'assets/img/HRIS-new/Payroll/payroll_master_data.png', caption: 'Payroll — Master Data' },
    { src: 'assets/img/HRIS-new/Payroll/payroll_form_input_manual.png', caption: 'Payroll — Input Manual' },
    { src: 'assets/img/HRIS-new/Payroll/Import Excell.png', caption: 'Payroll — Import Excel' },
    { src: 'assets/img/HRIS-new/Payroll/payroll_kp4_main.png', caption: 'Payroll — Rekap KP4' },
    { src: 'assets/img/HRIS-new/Payroll/payroll_kp4_form.png', caption: 'Payroll — Form Pengajuan KP4' },
    { src: 'assets/img/HRIS-new/Payroll/payroll_kp4_detail.png', caption: 'Payroll — Detail & Approval KP4' },
    { src: 'assets/img/HRIS-new/Payroll/payroll_verifikasi.png', caption: 'Payroll — Verifikasi (Manager SDM)' },
    { src: 'assets/img/HRIS-new/Payroll/payroll_laporan.png', caption: 'Payroll — Laporan (Export PDF)' },

    { src: 'assets/img/HRIS-new/Resignation/Main.png', caption: 'Resignation — Daftar Pengajuan (Migrasi)' },
    { src: 'assets/img/HRIS-new/Resignation/form.png', caption: 'Resignation — Form Pengajuan (Migrasi)' },
    { src: 'assets/img/HRIS-new/Resignation/detail.png', caption: 'Resignation — Detail & Approval (Migrasi)' },
    { src: 'assets/img/HRIS-new/Resignation/exit interview.png', caption: 'Resignation — Exit Interview (Migrasi)' },
    { src: 'assets/img/HRIS-new/Resignation/surat keterangan.png', caption: 'Resignation — Surat Keterangan (Migrasi)' },
    { src: 'assets/img/HRIS-new/Resignation/paklaring.png', caption: 'Resignation — Paklaring (Migrasi)' },

    { src: 'assets/img/HRIS-new/Masters/EmployeeAssessmentIndicator.png', caption: 'Master — Employee Assessment Indicator (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/WorkingHourType.png', caption: 'Master — Working Hour Type (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/MasterCuti.png', caption: 'Master — Cuti (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/MasterCuti_detail.png', caption: 'Master — Cuti (Detail) (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/PeriodeKerja.png', caption: 'Master — Periode Kerja (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/Position.png', caption: 'Master — Posisi/Jabatan (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/ResignationType.png', caption: 'Master — Jenis Resignation (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/WorkUnit.png', caption: 'Master — Unit Kerja (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/Lokasi.png', caption: 'Master — Lokasi (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/Lembur.png', caption: 'Master — Lembur (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/MasterActivityType.png', caption: 'Master — Jenis Aktivitas (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/MasterAttendanceStatus.png', caption: 'Master — Status Kehadiran (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/HrRule.png', caption: 'Master — Aturan HR (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/RefMasterData.png', caption: 'Master — Ref Master Data (Migrasi)' },
    { src: 'assets/img/HRIS-new/Masters/MasterType.png', caption: 'Master — Master Type (Migrasi)' },
  ],
  'app-absensi': [
    ...
    { src: 'assets/img/App Absensi/pengumuman.jpeg', caption: 'Pengumuman' },
  ...
  'evaluation': [
    { src: 'assets/img/evaluation/Dashboard.png', caption: 'Dashboard' },
